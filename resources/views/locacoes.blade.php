...
<div class="container mt-2">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold text-dark m-0">Painel Administrativo - Locações</h2>
        <div class="d-flex align-items-center">
            <a href="{{ route('filmes.create') }}" class="btn btn-primary fw-bold shadow-sm me-3">
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="badge bg-secondary">
                                        {{ $locacao->filme->titulo ?? 'Filme não encontrado' }}
                                    </span>
                                </td>
                                ...
                                <td class="text-success fw-bold">R$ {{ number_format($locacao->valor_locacao, 2, ',', '.') }}</td>
                        ...
                        @empty
                            <tr>
                                <td colspan="7" class="text-center py-4 text-muted">
                                    Nenhuma locação cadastrada no banco de dados ainda.
                                </td>
                            </tr>
                        @endforelse
                    </tbody>
